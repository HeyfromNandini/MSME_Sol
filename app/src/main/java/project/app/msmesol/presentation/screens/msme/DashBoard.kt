...
@Composable
fun DashBoard(paddingValues: PaddingValues, navController: NavController) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Row(
                ...
                DashBoardCards(name = "Manage Logistics", icon = Icons.Default.Image)
                DashBoardCards(name = "Manage Logistics", icon = Icons.Default.Image)
                DashBoardCards(name = "Manage Logistics", icon = Icons.Default.Image)
            }
...
@Composable
fun DashBoardCards(name: String, icon: ImageVector) {
    Card(
        modifier = Modifier
            .padding(8.dp)
            .size(85.dp)
